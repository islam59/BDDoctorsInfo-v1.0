    ...
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>  
      ...
      <div class="off-canvas-content" data-off-canvas-content style="min-height:765px; backgrond:white; padding:10px;">
          <button type="button" class="small secondary button" data-toggle="offCanvas" style="background:black;">Menu</button>  
            ...
            <h3>Update Bannar Image</h3><hr/>

            <div class="small-12 medium-2 large-2 columns">
                <!-- SPACING: FORM LEFT SPACING..--><p style="color:white;">site banner</p>
            </div>  
<?php
            ...
            <div class="small-12 medium-4 large-4 columns">
              <form action="" method="post" enctype="multipart/form-data">  
                <div class="form-group">
                  <input type="text" value="<?php echo $result['banner']; ?>" name="del_img">
                </div>
                <div class="form-group">                  
                  <img src="../logo/<?php echo $result['banner']; ?>" alt="no-logo-image" style="border:1px solid black; margin:10px 0px;"/>
                </div>
                <div class="form-group">
                    <label for="exampleFileUpload" class="button hollow">Change Banner</label>
